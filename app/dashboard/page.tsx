                        ...
                        <div className="bg-white p-6 rounded-3xl shadow-lg border border-gray-100 h-full">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                 ...
                                 <div>
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Filter by Tool Source</label>
                                    <select 
                                        className="w-full p-4 bg-gray-50 border-none rounded-xl focus:ring-2 focus:ring-[#001341] outline-none text-sm text-gray-600 font-medium"
