          ...
          {pricingPlans.map((plan) => (
            ...
            >
              ...
              <div>
                ...
                {/* WhatsApp Quick Quote for Pro Plan */}
                {plan.id === "pro" && (
                  <a
                    href="https://wa.me/918449488090?text=Hi%20AICLEX%2C%20I%20want%20a%20Zoom%20Pro%20quote%20for%20my%20team."
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full mt-3 py-3 rounded-full font-bold text-sm flex items-center justify-center gap-2 bg-green-500 text-white hover:bg-green-600 transition-all shadow"
                  >
